...
'''
running.py中注释了fine-tuning的部分，方便快速运行，如果需要fine-tuning，可以取消注释
'''
...
# --------------------------------------------------- I/O --------------------------------------------------------------
parser.add_argument('--data_dir', default='Dataset/UCIHAR', choices={'Dataset/UCIHAR', 'Dataset/DREAMER',
                                                                          'Dataset/STEW', 'Dataset/UCIHAR'}, help='Data directory')
