...
class BaseTrainer(object):
    ...
    def __init__(self, model, pre_train_loader, train_loader, test_loader, config, optimizer=None, l2_reg=None,
                 print_interval=10,
...
# 定义一个函数，用于获取矩阵的非对角元素  计算cov_loss时使用
def off_diagonal(x):
    n, m = x.shape
    assert n == m
